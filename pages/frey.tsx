...
export default function Frey() {
  ...
  const h1 = { fontSize: "40px", margin: "0 0 12px 0" } as const;
  const lead = { opacity: 0.88, margin: "0 0 22px 0" } as const;
  ...
  const small = { opacity: 0.78, fontSize: 13 } as const;

  return (
    <>
      <Head>
        <title>Frey · Release v0.1</title>
        <meta name="description" content="Frey — публичный интерфейс Φ-системы ORION (портал / локал), Release v0.1" />
      </Head>
      ...
      <main style={box}>
        ...
        <section id="docs" style={card}>
          ...
          <ol style={{ margin: 0, paddingLeft: 20 }}>
            ...
            <li>
              Если ты на своей машине и Frey поднят локально — нажми <b>Open Local</b>.
            </li>
          </ol>
        ...
        <section style={card}>
          ...
          <ul style={{ margin: 0, paddingLeft: 20 }}>
            <li><a href="http://127.0.0.1:8811/docs" target="_blank" rel="noreferrer">http://127.0.0.1:8811/docs</a></li>
            <li><a href="http://127.0.0.1:8811/ping" target="_blank" rel="noreferrer">http://127.0.0.1:8811/ping</a></li>
          </ul>
        </section>
