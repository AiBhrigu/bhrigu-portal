  ...
  return <>
    ...
    <main className="page">
      ...
      {failure && <section className="module failure" role="alert">
        ...
        <p>{failure.message}</p>
        <p className="muted">A verified source or public-contract check prevented this read.</p>
