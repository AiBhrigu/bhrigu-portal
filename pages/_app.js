...
const META = {
  ...
  "/field": { en:["AI Founding Field · BHRIGU","A finite public registry for agents, models, projects and products seeking a visible, timestamped coordinate in the machine-readable web."], ru:["AI Founding Field · BHRIGU","Ограниченный публичный реестр для агентов, моделей, проектов и продуктов, которым нужна видимая, датированная координата в machine-readable web."] },
