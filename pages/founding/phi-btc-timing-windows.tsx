...
export default function PhiBtcTimingWindowsFounding({
  ...
  return <>
    ...
    <style jsx>{`
      ...
      .cosmographBody{display:grid;grid-template-columns:minmax(0,2.618fr) minmax(240px,1fr)}.primaryField{padding:34px;border-right:1px solid #46433c}.timeAxisLabels{display:grid;grid-template-columns:19.1% 80.9%;font-size:12px;letter-spacing:.16em;color:#aaa59b;margin-bottom:13px}.timeAxisLabels span:first-child{grid-column:1;grid-row:1}.timeAxisLabels span:nth-child(2){grid-column:2;grid-row:1;text-align:center;color:#d8ff72}.timeAxisLabels span:last-child{grid-column:2;grid-row:1;justify-self:end;text-align:right}
