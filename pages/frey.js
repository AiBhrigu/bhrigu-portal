...
.askFreyBox{gap:var(--phi-13);--phi_gap_v2:1;border:1px solid rgba(215,181,90,0.36);background:linear-gradient(180deg, rgba(255,255,255,0.055), rgba(0,0,0,0.26));box-shadow:inset 0 0 0 1px rgba(255,255,255,0.065),0 14px 44px rgba(0,0,0,0.42),0 0 0 1px rgba(215,181,90,0.12);border-radius:18px;padding:var(--phi-13) var(--phi-21);--phi_pad_v2:1;--frey_phi_tokens_v1_0:1;--frey_askfrey_air2_v1_0_5:1;}
