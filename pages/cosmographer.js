...
export default function Cosmographer() {
  ...
  return (
    <main className="phiPageFrame" data-phi-page="PHI_COSMOGRAPHER_DOM_MARK_V0_23">
      <Head>
      ...
      <main className="phiPageFrame" data-cosmo-quickmap="COSMO_QUICKMAP_POLISH_V0_4" style={{ maxWidth: 980, margin: "0 auto", padding: "48px 18px" }} data-cosmo="COSMO_QUICKMAP_POLISH_V0_4" data-cosmographer-ui="COSMOGRAPHER_UI_MARK_V0_1" data-cosmographer-center="COSMOGRAPHER_CENTER_V0_13">
