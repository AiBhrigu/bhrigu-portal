    ...
    <>
      ...
      <main className="field" lang={locale}>
        <section className="hero">
          ...
          <div className="heroBody">
            <div className="heroCopy">
              ...
              <p className="foundingLaw">RELEASE 01 · 32 FOUNDING COORDINATES · ONE COORDINATE = ONE PUBLIC NODE</p>
            </div>
            <div className="fieldScene" aria-label={locale === "ru" ? "Визуальная карта founding-поля" : "Visual map of the founding field"}>
              ...
              <div className="orbitTicks" aria-hidden="true">{slots.map((slot, i) => <i key={`tick-${slot}`} style={{ "--angle": `${i * 11.25}deg` }} />)}</div>
              {[
        ...
        <section className="gridPanel">
          <div className="sectionHead"><div><p className="eyebrow">PUBLIC FIELD / RELEASE 01</p><h2>{locale === "ru" ? "Свободные координаты" : "Available coordinates"}</h2></div><span className="counter">32 · RELEASE 01</span></div>
