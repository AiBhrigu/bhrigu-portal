...
BTC_PR114_STACKED_SESSION_VERIFIER_SCOPE = {
    ".github/scripts/verify-btc-public-acceptance-scope.py",
    ".github/workflows/btc-pr114-protected-founder-replay.yml",
    ".github/workflows/btc-pr114-stacked-session-verifier.yml",
...
accepted_scopes = {
    ...
    "PASS_BTC_PR114_STACKED_SESSION_VERIFIER_EXACT_4_FILE_SCOPE": BTC_PR114_STACKED_SESSION_VERIFIER_SCOPE,
}
