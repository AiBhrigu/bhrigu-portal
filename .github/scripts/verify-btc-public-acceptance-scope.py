...
BTC_QUICK_ENTRY_CLEAN_CHAT_DIRECT_ROUTING_REPAIR_SCOPE = {
    ".github/scripts/verify-btc-public-acceptance-scope.py",
...
accepted_scopes = {
    ...
    "PASS_BTC_QUICK_ENTRY_CLEAN_CHAT_DIRECT_ROUTING_REPAIR_EXACT_3_FILE_SCOPE": BTC_QUICK_ENTRY_CLEAN_CHAT_DIRECT_ROUTING_REPAIR_SCOPE,
