...
async function run() {
  ...
  assert.match(component, /data-active-session-hierarchy="phi-action-signal-v0-1"/);
  assert.match(component, /data-primary-safety-rail/);
  assert.match(component, /data-qr-core="phi-functional-bitcoin-action-v0-1"/);
  ...
  assert.match(support, /feature\/btc-support-phi-structured-cyberpunk-v0-1/);
  assert.match(support, /data-support-visual-canon="bhrigu-phi-structured-cyberpunk-v0-1"/);
  assert.match(support, /data-phi-primary-regions="2"/);
  assert.match(support, /data-phi-ratio="61\.803398875:38\.196601125"/);
  assert.match(support, /data-phi-region="meaning-trust-61_8"/);
  assert.match(support, /data-phi-region="bitcoin-action-38_2"/);
  assert.match(support, /grid-template-columns: minmax\(0,61\.803398875fr\) minmax\(0,38\.196601125fr\)/);
  assert.match(component, /data-support-final-polish="bhrigu-phi-structured-cyberpunk-v0-1"/);
  assert.match(component, /data-action-energy="state-driven"/);
  assert.match(component, /terminal-mempool_seen \{ animation: receiptEvidenceIn/);
  assert.match(component, /terminal-confirmed \{[^}]*animation: receiptResolutionIn/);
  assert.doesNotMatch(support, /supportField|fieldAxis|fieldCore|supportSignalDrift/);
  assert.doesNotMatch(component, /qrCore::before|cornerTl|cornerTr|cornerBl|cornerBr|supportPulse/);
