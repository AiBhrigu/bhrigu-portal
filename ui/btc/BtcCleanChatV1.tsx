...
export default function BtcCleanChatV1({ locale, initialQuestion = "" }: Props) {
  ...
  return <main className="cleanChatPage" lang={locale} data-clean-chat="btc-v1" data-session-local="true">
    ...
    <style jsx global>{`
      ...
      .cleanVisualStateLabel{color:#dfe4e9!important}.cleanSemanticVisual[data-semantic-state="DIVERGENCE"] .cleanVisualState{background:linear-gradient(90deg,#6aa8ff 0 43%,transparent 43% 57%,#6aa8ff 57%)!important}.cleanSemanticVisual[data-semantic-state="LIMITED"] .cleanVisualState{background:repeating-linear-gradient(90deg,#8f99a5 0 7px,transparent 7px 13px)!important}.cleanSemanticVisual[data-semantic-state="TEMPORAL"] .cleanVisualState{background:#8f7cf4!important}.cleanSemanticVisual[data-semantic-state="EXPECTATION"] .cleanVisualState{background:linear-gradient(90deg,#6aa8ff,#8f7cf4)!important}.cleanVisualIdentity>b,.cleanVisualIdentity>span,.cleanVisualMetrics small,.cleanVisualMetrics b,.cleanFreshness,.cleanAsOf,.cleanCopyAction,.cleanBoundary,.cleanSourceList small,.cleanRole{font-size:12px!important}.cleanSourceList small,.cleanAsOf,.cleanCopyAction,.cleanBoundary,.cleanVisualMetrics small,.cleanFreshness{color:#aab2bd!important}.cleanComposer textarea::placeholder{color:#aab2bd!important}
    `}</style>
  </main>;
}
