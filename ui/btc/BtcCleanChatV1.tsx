...
export default function BtcCleanChatV1({ locale, initialQuestion = "" }: Props) {
  ...
  return <main className="cleanChatPage" lang={locale} data-clean-chat="btc-v1" data-session-local="true">
    ...
    .cleanSemanticVisual[data-semantic-state="DIVERGENCE"] .cleanVisualState { background: var(--blue); }
    .cleanSemanticVisual[data-semantic-state="EXPECTATION"] .cleanVisualState { background: linear-gradient(90deg, var(--blue), var(--sup)); }
    .cleanSemanticVisual[data-semantic-state="TEMPORAL"] .cleanVisualState { background: var(--sup); }
    ...
    .cleanVisualStateLabel { grid-column: 4 / -1; color: var(--blue); font-weight: 700; }
    .cleanSemanticVisual[data-semantic-state="DIVERGENCE"] .cleanVisualStateLabel { color: var(--blue); }
    .cleanSemanticVisual[data-semantic-state="LIMITED"] .cleanVisualStateLabel { color: #c7d0da; }
    .cleanSemanticVisual[data-semantic-state="TEMPORAL"] .cleanVisualStateLabel { color: var(--sup); }
    .cleanSemanticVisual[data-semantic-state="EXPECTATION"] .cleanVisualStateLabel { color: var(--sup); }
    .cleanComposer textarea::placeholder { color: #aeb9c5; opacity: 1; }
    @media(max-width:680px) {
      .cleanVisualStateLabel { grid-column: 2 / 5; }
      .cleanVisualIdentity>b, .cleanVisualIdentity>span, .cleanVisualMetrics small, .cleanVisualMetrics b,
      .cleanFreshness, .cleanAsOf, .cleanCopyAction, .cleanBoundary, .cleanSourceList small,
      .cleanVisualStateLabel { font-size: 12px; }
    }
