...
function normalizePolymarketProposition(value: string): string {
  return value
    ...
    .replace(/\b(достигнет|достигнуть|достичь|достигает|достиг)\b/g, "reach")
    .replace(/\b(коснется|коснётся|ударит)\b/g, "hit")
