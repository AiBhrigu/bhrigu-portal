...
.heroDialogueGateway{min-height:clamp(390px,50svh,520px)}
...
.productOutcomeHeader{display:grid;gap:10px;max-width:760px;padding:clamp(58px,8vw,100px) 0 26px}.productOutcomeHeader h2{margin:0;font-size:clamp(35px,5vw,60px);line-height:1;letter-spacing:-.045em;text-wrap:balance}.productOutcomeHeader>p:last-child{margin:0;color:var(--t2);font-size:17px;line-height:1.6}
...
@media(max-width:1080px){.heroProductEntry{grid-template-columns:1fr;min-height:auto;padding-top:42px}.heroProductCopy{max-width:50rem}.heroQuestionCard{min-height:0}.productOutcomeGrid{grid-template-columns:repeat(2,minmax(0,1fr))}}
