...
const RELATION_OPERATOR = /impact|influence|affect|correlat|coincid|relation|compare|versus|\bvs\b|повлиял|влияни|связ|совпал|корреляц|сравн|между|подтверж/i;
