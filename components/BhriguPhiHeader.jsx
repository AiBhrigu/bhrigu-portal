...
export default function BhriguPhiHeader() {
  ...
  return (
    <header
      className={`bh-header${home ? " bh-header-home" : ""}`}
      data-hdr={home ? "BHRIGU_PUBLIC_HOME_HEADER_V0_1" : "HDR_CANON_GOLDENPATH_V0_1 HDR_LOGO_GUTTER_ALIGN_V0_5 HDR_PLAQUE_PREMIUM_V0_3"}
