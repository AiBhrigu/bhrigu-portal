...
export default function BhriguPhiHeader() {
  const css = `
    ...
    .bh-ctas { display: inline-flex; gap: 10px; align-items: center; }
    .bh-btn {
      display: inline-flex;
      align-items: center;
    ...
    .bh-btn:hover { border-color: rgba(255,255,255,0.22); background: rgba(255,255,255,0.05); }
    .bh-btn-primary {
    ...
    .bh-btn-primary:hover { background: rgba(255,255,255,0.98); }
    @media (max-width: 520px) {
      .bh-shell { padding: 12px 12px; }
      .bh-sub { display: none; }
      .bh-btn { padding: 9px 12px; }
    }
  `;
      ...
      <div className="bh-shell">
        <a className="bh-brand" href="/" aria-label="BHRIGU home">
          <span className="bh-plaque">
            ...
            <span className="bh-sub">surface canon</span>
          </span>
        </a>
