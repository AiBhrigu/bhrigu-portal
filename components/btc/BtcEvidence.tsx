...
function freshnessBoundary(locale:BtcPublicLocale,freshness:BtcPublicSnapshot["market_snapshot"]["freshness"]):string{
 if(locale==="ru")return freshness==="FRESH"?"Проверенный источник находится в пределах 24-часового окна актуальности.":"Проверенный источник старше 24 часов; сильные утверждения о текущем состоянии подавлены.";
 return freshness==="FRESH"?"The verified source is within the 24-hour freshness window.":"The verified source is older than 24 hours; strong current-state language is suppressed.";
}
